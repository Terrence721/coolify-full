...
class BackupFailed extends CustomEmailNotification
{
    ...
    public function __construct(ScheduledDatabaseBackup $backup, public StandaloneDatabaseInstance|ServiceDatabase $database, public string $output, public string $database_name)
    {
        $this->onQueue('high');
