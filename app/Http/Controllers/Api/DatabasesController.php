...
class DatabasesController extends Controller
{
            ...
            content: new OA\MediaType(
                ...
                schema: new OA\Schema(
                    ...
                    properties: [
                        ...
                        new OA\Property(property: 'public_port_timeout', type: 'integer', description: 'Public port timeout in seconds (default: 3600)'),
                        ...
                        new OA\Property(property: 'health_check_enabled', type: 'boolean', description: 'Enable the database healthcheck probe.', default: true),
                        new OA\Property(property: 'health_check_interval', type: 'integer', description: 'Healthcheck interval in seconds.', minimum: 1, default: 15),
                        new OA\Property(property: 'health_check_timeout', type: 'integer', description: 'Healthcheck timeout in seconds.', minimum: 1, default: 5),
                        new OA\Property(property: 'health_check_retries', type: 'integer', description: 'Healthcheck retries count.', minimum: 1, default: 5),
                        new OA\Property(property: 'health_check_start_period', type: 'integer', description: 'Healthcheck start period in seconds.', minimum: 0, default: 5),
                    ],
                ),
            )
        ),
        ...
        requestBody: new OA\RequestBody(
            ...
            content: new OA\MediaType(
                ...
                schema: new OA\Schema(
                    ...
                    required: ['frequency'],
                    properties: [
                        new OA\Property(property: 'frequency', type: 'string', description: 'Backup frequency (cron expression or: every_minute, hourly, daily, weekly, monthly, yearly)'),
                        new OA\Property(property: 'enabled', type: 'boolean', description: 'Whether the backup is enabled', default: true),
                        new OA\Property(property: 'save_s3', type: 'boolean', description: 'Whether to save backups to S3', default: false),
                        ...
                        new OA\Property(property: 'dump_all', type: 'boolean', description: 'Whether to dump all databases', default: false),
                        new OA\Property(property: 'backup_now', type: 'boolean', description: 'Whether to trigger backup immediately after creation'),
                        new OA\Property(property: 'database_backup_retention_amount_locally', type: 'integer', description: 'Number of backups to retain locally'),
                        new OA\Property(property: 'database_backup_retention_days_locally', type: 'integer', description: 'Number of days to retain backups locally'),
                        new OA\Property(property: 'database_backup_retention_max_storage_locally', type: 'number', description: 'Max storage (GB) for local backups'),
                        ...
                        new OA\Property(property: 'database_backup_retention_max_storage_s3', type: 'number', description: 'Max storage (GB) for S3 backups'),
                        new OA\Property(property: 'timeout', type: 'integer', description: 'Backup job timeout in seconds (min: 60, max: 36000)', default: 3600),
                    ],
                ),
            )
        ),
            ...
            content: new OA\MediaType(
                ...
                schema: new OA\Schema(
                    ...
                    properties: [
                        ...
                        new OA\Property(property: 'database_backup_retention_amount_locally', type: 'integer', description: 'Retention amount of the backup locally'),
                        new OA\Property(property: 'database_backup_retention_days_locally', type: 'integer', description: 'Retention days of the backup locally'),
                        new OA\Property(property: 'database_backup_retention_max_storage_locally', type: 'number', description: 'Max storage of the backup locally'),
                        ...
                        new OA\Property(property: 'database_backup_retention_max_storage_s3', type: 'number', description: 'Max storage of the backup in S3'),
                        new OA\Property(property: 'timeout', type: 'integer', description: 'Backup job timeout in seconds (min: 60, max: 36000)', default: 3600),
                    ],
                ),
            )
    ...
    public function create_database(Request $request, NewDatabaseTypes $type): JsonResponse
    {
    ...
    public function storages(Request $request): JsonResponse
    {
        ...
        return response()->json($this->apiStoragesPayload($database));
    }
    ...
    public function create_storage(Request $request): JsonResponse
    {
        ...
        return $this->applyApiStorageCreate($request, $database, $database, [
            'event' => 'api.database.storage',
            'resourceKey' => 'database_uuid',
        ], $teamId, $database->uuid);
    }
    ...
    public function update_storage(Request $request): JsonResponse
    {
        ...
        $storage = $this->resolveApiStorageForUpdate($request, $database);
    ...
    public function delete_storage(Request $request): JsonResponse
    {
        ...
        $storage = $this->findApiStorageByUuid($database, $storageUuid);
        ...
        return $this->applyApiStorageDelete($storage, [
            'event' => 'api.database.storage',
            'resourceKey' => 'database_uuid',
        ], $teamId, $database->uuid, $storageUuid);
    }
}
