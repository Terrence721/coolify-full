...
class ApplicationsController extends Controller
{
                ...
                new OA\MediaType(
                    ...
                    schema: new OA\Schema(
                        ...
                        properties: [
                            ...
                            new OA\Property(property: 'environment_name', type: 'string', description: 'The environment name. You need to provide at least one of environment_name or environment_uuid.'),
                            new OA\Property(property: 'environment_uuid', type: 'string', description: 'The environment UUID. You need to provide at least one of environment_name or environment_uuid.'),
                            ...
                            new OA\Property(property: 'build_pack', type: 'string', enum: ['nixpacks', 'railpack', 'static', 'dockerfile', 'dockercompose'], description: 'The build pack type.'),
                            ...
                            new OA\Property(property: 'domains', type: 'string', description: 'The application URLs in a comma-separated list.'),
                            ...
                            new OA\Property(property: 'is_spa', type: 'boolean', description: 'The flag to indicate if the application is a single-page application (SPA). Only relevant when is_static is true.'),
                            new OA\Property(property: 'is_auto_deploy_enabled', type: 'boolean', description: 'The flag to indicate if auto-deploy is enabled on git push. Defaults to true.'),
                            new OA\Property(property: 'is_force_https_enabled', type: 'boolean', description: 'The flag to indicate if HTTPS is forced. Defaults to true.'),
                            new OA\Property(property: 'static_image', type: 'string', enum: ['nginx:alpine'], description: 'The static image.'),
                            ...
                            new OA\Property(property: 'dockerfile_location', type: 'string', description: 'The Dockerfile location in the repository.'),
                            ...
                            new OA\Property(property: 'docker_compose_domains', type: 'array', description: 'Array of URLs to be applied to containers of a dockercompose application.', items: new OA\Items(type: 'object', properties: [new OA\Property(property: 'name', type: 'string', description: 'The service name as defined in docker-compose.'), new OA\Property(property: 'domain', type: 'string', description: 'Comma-separated list of URLs (e.g. "https://app.coolify.io,https://app2.coolify.io")')])),
                            ...
                            new OA\Property(property: 'autogenerate_domain', type: 'boolean', default: true, description: 'If true and domains is empty, auto-generate a domain using the server\'s wildcard domain or sslip.io fallback. Default: true.'),
                            new OA\Property(property: 'is_container_label_escape_enabled', type: 'boolean', default: true, description: 'Escape special characters in labels. By default, $ (and other chars) is escaped. So if you write $ in the labels, it will be saved as $$. If you want to use env variables inside the labels, turn this off.'),
                            new OA\Property(property: 'is_preserve_repository_enabled', type: 'boolean', default: false, description: 'Preserve repository during deployment.'),
                        ],
                    )
                ),
            ]
                ...
                new OA\MediaType(
                    ...
                    schema: new OA\Schema(
                        ...
                        properties: [
                            ...
                            new OA\Property(property: 'environment_uuid', type: 'string', description: 'The environment UUID. You need to provide at least one of environment_name or environment_uuid.'),
                            new OA\Property(property: 'dockerfile', type: 'string', description: 'The Dockerfile content.'),
                            new OA\Property(property: 'build_pack', type: 'string', enum: ['dockerfile'], description: 'The build pack type.'),
                            new OA\Property(property: 'ports_exposes', type: 'string', description: 'The ports to expose.'),
                            new OA\Property(property: 'destination_uuid', type: 'string', description: 'The destination UUID.'),
                            new OA\Property(property: 'name', type: 'string', description: 'The application name.'),
                            new OA\Property(property: 'description', type: 'string', description: 'The application description.'),
    ...
    public function update_by_uuid(Request $request): JsonResponse
    {
        ...
        if ($requestHasDomains && $server->isProxyShouldRun()) {
            ...
            $errors = [];
            $urls = $urls->trim()->explode(',')->map(function ($url) use (&$errors) {
                $url = trim($url);
                ...
                new OA\MediaType(
                    ...
                    schema: new OA\Schema(
                        ...
                        properties: [
                            ...
                            new OA\Property(property: 'is_literal', type: 'boolean', description: 'The flag to indicate if the environment variable is a literal, nothing escaped.'),
