...
#[OA\Schema(
    ...
    type: 'object',
    properties: [
        new OA\Property(property: 'uuid', type: 'string', description: 'The unique identifier of the execution.'),
        new OA\Property(property: 'status', type: 'string', enum: ['success', 'failed', 'running'], description: 'The status of the execution.'),
        new OA\Property(property: 'message', type: 'string', nullable: true, description: 'The output message of the execution.'),
        new OA\Property(property: 'retry_count', type: 'integer', description: 'The number of retries.'),
        new OA\Property(property: 'duration', type: 'number', nullable: true, description: 'Duration in seconds.'),
        new OA\Property(property: 'started_at', type: 'string', format: 'date-time', nullable: true, description: 'When the execution started.'),
        new OA\Property(property: 'finished_at', type: 'string', format: 'date-time', nullable: true, description: 'When the execution finished.'),
        new OA\Property(property: 'created_at', type: 'string', format: 'date-time', description: 'When the record was created.'),
        new OA\Property(property: 'updated_at', type: 'string', format: 'date-time', description: 'When the record was last updated.'),
    ],
)]
