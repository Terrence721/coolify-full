...
#[OA\Schema(
    ...
    properties: [
        ...
        new OA\Property(property: 'configuration_hash', type: 'string', nullable: true),
        new OA\Property(property: 'configuration_snapshot', type: 'object', nullable: true),
        new OA\Property(property: 'configuration_diff', type: 'object', nullable: true),
