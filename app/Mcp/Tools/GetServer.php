...
class GetServer extends Tool
{
    ...
    public function handle(Request $request): Response
    {
        ...
        $data['is_reachable'] = data_get($server, 'settings.is_reachable');
        $data['is_usable'] = data_get($server, 'settings.is_usable');
        $data['connection_timeout'] = data_get($server, 'settings.connection_timeout');
