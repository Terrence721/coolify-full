...
class NotificationPolicyTest extends TestCase
{
     ...
     * the real controllers reach this policy (Gate::authorize() resolves the plain
     * Auth::user() instance, not a pivot-loaded one). Setting the session directly here
     * mirrors that real path instead of shortcutting through the pivot.
     */
