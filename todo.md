...
| Coverage | 154 tests across 17 suites — `Toast.jsx`, `useTeamChannel.js`, `Notifications/Email.jsx`, `ServerNavbar.jsx`, `AppLayout.jsx`, `useAppearance.js`'s `applyZoom()`, `Project/Resource/Create.jsx`, `app.js` (password toggle, info tooltip, 2FA challenge), `GlobalSearchModal.jsx`, `LayoutPopups.jsx`, `WhatsNewButton.jsx`, `RollbackTab.jsx`, `ConfigurationChecker.jsx`, `DomainConflictModal.jsx`, `SharedVariablesManager.jsx`, `PasswordConfirmModal.jsx`, `DatabaseImportTab.jsx` |
