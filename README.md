...
- **[`code-review.csv`](code-review.csv)** — real line-level code review notes, done as a reviewer role separate from the engineer who fixes them (see `todo.md`). Open it directly in GitHub or an editor with CSV column support.
