...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::prefix('project/{project_uuid}/environment/{environment_uuid}/application/{application_uuid}')->group(function () {
        ...
        Route::patch('/environment-variables/{env_id}', [ProjectApplicationConfigurationController::class, 'updateEnv'])->name('project.application.envs.update');
        Route::post('/environment-variables/{env_id}/lock', [ProjectApplicationConfigurationController::class, 'lockEnv'])->name('project.application.envs.lock');
        Route::delete('/environment-variables/{env_id}', [ProjectApplicationConfigurationController::class, 'destroyEnv'])->name('project.application.envs.destroy');
        Route::get('/persistent-storage', [ProjectApplicationConfigurationController::class, 'show'])->name('project.application.persistent-storage');
        Route::post('/persistent-storage/volume', [ProjectApplicationConfigurationController::class, 'storagesVolumeStore'])->name('project.application.storages.volume.store');
        Route::patch('/persistent-storage/volume/{volume_id}', [ProjectApplicationConfigurationController::class, 'storagesVolumeUpdate'])->name('project.application.storages.volume.update');
        Route::delete('/persistent-storage/volume/{volume_id}', [ProjectApplicationConfigurationController::class, 'storagesVolumeDestroy'])->name('project.application.storages.volume.destroy');
        Route::post('/persistent-storage/file', [ProjectApplicationConfigurationController::class, 'storagesFileStore'])->name('project.application.storages.file.store');
        Route::post('/persistent-storage/directory', [ProjectApplicationConfigurationController::class, 'storagesDirectoryStore'])->name('project.application.storages.directory.store');
        Route::patch('/persistent-storage/file/{file_id}', [ProjectApplicationConfigurationController::class, 'storagesFileUpdate'])->name('project.application.storages.file.update');
        Route::post('/persistent-storage/file/{file_id}/load', [ProjectApplicationConfigurationController::class, 'storagesFileLoad'])->name('project.application.storages.file.load');
        ...
        Route::get('/source', [ProjectApplicationConfigurationController::class, 'show'])->name('project.application.source');
        Route::patch('/source', [ProjectApplicationConfigurationController::class, 'updateSource'])->name('project.application.source.update');
        Route::patch('/source/private-key', [ProjectApplicationConfigurationController::class, 'setSourcePrivateKey'])->name('project.application.source.set-private-key');
        Route::post('/source/change', [ProjectApplicationConfigurationController::class, 'changeSource'])->name('project.application.source.change');
        ...
        Route::post('/tasks/{task_uuid}/toggle', [ProjectApplicationConfigurationController::class, 'scheduledTaskToggle'])->name('project.application.scheduled-tasks.toggle');
        ...
        Route::get('/preview-deployments', [ProjectApplicationConfigurationController::class, 'show'])->name('project.application.preview-deployments');
        Route::patch('/preview-deployments/template', [ProjectApplicationConfigurationController::class, 'updatePreviewUrlTemplate'])->name('project.application.previews.template.update');
        Route::post('/preview-deployments/load-prs', [ProjectApplicationConfigurationController::class, 'loadPullRequests'])->name('project.application.previews.load-prs');
        Route::post('/preview-deployments', [ProjectApplicationConfigurationController::class, 'addPreview'])->name('project.application.previews.store');
        Route::post('/preview-deployments/deploy', [ProjectApplicationConfigurationController::class, 'addAndDeployPreview'])->name('project.application.previews.add-deploy');
        Route::patch('/preview-deployments/{pull_request_id}/domain', [ProjectApplicationConfigurationController::class, 'savePreviewDomain'])->name('project.application.previews.domain.update');
        Route::post('/preview-deployments/{pull_request_id}/domain/generate', [ProjectApplicationConfigurationController::class, 'generatePreviewDomain'])->name('project.application.previews.domain.generate');
        Route::patch('/preview-deployments/{pull_request_id}/compose-domain', [ProjectApplicationConfigurationController::class, 'savePreviewComposeDomain'])->name('project.application.previews.compose-domain.update');
        Route::post('/preview-deployments/{pull_request_id}/compose-domain/generate', [ProjectApplicationConfigurationController::class, 'generatePreviewComposeDomain'])->name('project.application.previews.compose-domain.generate');
        Route::post('/preview-deployments/{pull_request_id}/deploy', [ProjectApplicationConfigurationController::class, 'deployPreview'])->name('project.application.previews.deploy');
        ...
        Route::post('/resource-operations/clone', [ProjectApplicationConfigurationController::class, 'clone'])->name('project.application.clone');
        Route::post('/resource-operations/move', [ProjectApplicationConfigurationController::class, 'move'])->name('project.application.move');
        ...
        Route::get('/tags', [ProjectApplicationConfigurationController::class, 'show'])->name('project.application.tags');
        Route::post('/tags', [ProjectApplicationConfigurationController::class, 'storeTag'])->name('project.application.tags.store');
        Route::delete('/tags/{tag_id}', [ProjectApplicationConfigurationController::class, 'destroyTag'])->name('project.application.tags.destroy');
        Route::get('/danger', [ProjectApplicationConfigurationController::class, 'show'])->name('project.application.danger');
        Route::delete('/', [ProjectApplicationConfigurationController::class, 'destroy'])->name('project.application.destroy');
        ...
        Route::get('/tasks/{task_uuid}', [ProjectApplicationConfigurationController::class, 'show'])->name('project.application.scheduled-tasks');
    });
    Route::prefix('project/{project_uuid}/environment/{environment_uuid}/database/{database_uuid}')->group(function () {
        ...
        Route::get('/import-backup', [ProjectDatabaseConfigurationController::class, 'show'])->name('project.database.import-backup')->middleware('can.update.resource');
        Route::post('/import-backup/check-file', [ProjectDatabaseConfigurationController::class, 'importCheckFileEndpoint'])->name('project.database.import.check-file')->middleware('can.update.resource');
        Route::post('/import-backup/run', [ProjectDatabaseConfigurationController::class, 'importRunEndpoint'])->name('project.database.import.run')->middleware('can.update.resource');
        Route::post('/import-backup/s3/check', [ProjectDatabaseConfigurationController::class, 'importCheckS3Endpoint'])->name('project.database.import.check-s3')->middleware('can.update.resource');
        Route::post('/import-backup/s3/restore', [ProjectDatabaseConfigurationController::class, 'importRestoreS3Endpoint'])->name('project.database.import.restore-s3')->middleware('can.update.resource');
    ...
    Route::prefix('project/{project_uuid}/environment/{environment_uuid}/service/{service_uuid}')->group(function () {
        ...
        Route::get('/{stack_service_uuid}/import', [ProjectServiceResourceController::class, 'import'])->name('project.service.database.import')->middleware('can.update.resource');
        Route::post('/{stack_service_uuid}/import/check-file', [ProjectServiceResourceController::class, 'importCheckFileEndpoint'])->name('project.service.database.import.check-file')->middleware('can.update.resource');
        Route::post('/{stack_service_uuid}/import/run', [ProjectServiceResourceController::class, 'importRunEndpoint'])->name('project.service.database.import.run')->middleware('can.update.resource');
        Route::post('/{stack_service_uuid}/import/s3/check', [ProjectServiceResourceController::class, 'importCheckS3Endpoint'])->name('project.service.database.import.check-s3')->middleware('can.update.resource');
        Route::post('/{stack_service_uuid}/import/s3/restore', [ProjectServiceResourceController::class, 'importRestoreS3Endpoint'])->name('project.service.database.import.restore-s3')->middleware('can.update.resource');
