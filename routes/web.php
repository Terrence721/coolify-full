...
use App\Livewire\Project\Resource\GitCreate as ResourceGitCreate;
...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::prefix('project/{project_uuid}/environment/{environment_uuid}')->group(function () {
        ...
        Route::get('/new/git', ResourceGitCreate::class)->name('project.resource.create.git')->middleware('can.create.resources');
