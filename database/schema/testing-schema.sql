...
-- Date: 2026-09-14 14:41:35
-- Last migration: 2026_08_03_212408_add_oauth_provider_to_users_table
...
CREATE TABLE IF NOT EXISTS "additional_destinations" (
    ...
    FOREIGN KEY ("standalone_docker_id") REFERENCES "standalone_dockers" ("id") ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "application_previews" (
    ...
    "last_online_at" TEXT DEFAULT '2026-07-01 19:53:39' NOT NULL,
    "deleted_at" TEXT,
    "docker_registry_image_tag" TEXT
);
...
CREATE TABLE IF NOT EXISTS "applications" (
    ...
    "max_restart_count" INTEGER DEFAULT 10 NOT NULL,
    "team_id" INTEGER
);
...
CREATE TABLE IF NOT EXISTS "instance_settings" (
    ...
    "is_mcp_server_enabled" INTEGER DEFAULT false NOT NULL
);
...
CREATE TABLE IF NOT EXISTS "personal_access_tokens" (
    ...
    "created_at" TEXT,
    "updated_at" TEXT,
    "api_token_expiration_warning_sent_at" TEXT
);
...
CREATE TABLE IF NOT EXISTS "servers" (
    ...
    "sentinel_updated_at" TEXT DEFAULT '2026-07-01 19:53:39' NOT NULL,
    "deleted_at" TEXT,
    "ip_previous" TEXT,
    ...
    FOREIGN KEY ("cloud_provider_token_id") REFERENCES "cloud_provider_tokens" ("id") ON DELETE SET NULL
);
...
CREATE TABLE IF NOT EXISTS "standalone_clickhouses" (
    ...
    "health_check_interval" INTEGER DEFAULT 15 NOT NULL,
    "health_check_timeout" INTEGER DEFAULT 5 NOT NULL,
    "health_check_retries" INTEGER DEFAULT 5 NOT NULL,
    "health_check_start_period" INTEGER DEFAULT 5 NOT NULL
);
...
CREATE INDEX IF NOT EXISTS "application_previews_application_id_index" ON "application_previews" (application_id);
...
CREATE INDEX IF NOT EXISTS "applications_team_id_index" ON "applications" (team_id);
...
CREATE INDEX IF NOT EXISTS "personal_access_tokens_expiration_warning_index" ON "personal_access_tokens" (expires_at, api_token_expiration_warning_sent_at);
...
CREATE INDEX IF NOT EXISTS "servers_sentinel_updated_at_index" ON "servers" (sentinel_updated_at);
CREATE UNIQUE INDEX IF NOT EXISTS "servers_uuid_unique" ON "servers" (uuid);
CREATE INDEX IF NOT EXISTS "service_applications_service_id_index" ON "service_applications" (service_id);
CREATE UNIQUE INDEX IF NOT EXISTS "service_applications_uuid_unique" ON "service_applications" (uuid);
CREATE INDEX IF NOT EXISTS "service_databases_service_id_index" ON "service_databases" (service_id);
...
CREATE INDEX IF NOT EXISTS "services_server_id_index" ON "services" (server_id);
CREATE INDEX IF NOT EXISTS "services_team_id_index" ON "services" (team_id);
...
CREATE INDEX IF NOT EXISTS "swarm_dockers_server_id_index" ON "swarm_dockers" (server_id);
...
INSERT INTO "migrations" ("id", "migration", "batch") VALUES (294, '2025_11_05_091558_add_stop_grace_period_to_application_settings', 294);
INSERT INTO "migrations" ("id", "migration", "batch") VALUES (295, '2025_11_09_000001_add_timeout_to_scheduled_tasks_table', 295);
INSERT INTO "migrations" ("id", "migration", "batch") VALUES (296, '2025_11_09_000002_improve_scheduled_task_executions_tracking', 296);
INSERT INTO "migrations" ("id", "migration", "batch") VALUES (297, '2025_11_10_112500_add_restart_tracking_to_applications_table', 297);
INSERT INTO "migrations" ("id", "migration", "batch") VALUES (298, '2025_11_12_130931_add_traefik_version_tracking_to_servers_table', 298);
INSERT INTO "migrations" ("id", "migration", "batch") VALUES (299, '2025_11_12_131252_add_traefik_outdated_to_email_notification_settings', 299);
INSERT INTO "migrations" ("id", "migration", "batch") VALUES (300, '2025_11_12_133400_add_traefik_outdated_thread_id_to_telegram_notification_settings', 300);
INSERT INTO "migrations" ("id", "migration", "batch") VALUES (301, '2025_11_14_114632_add_traefik_outdated_info_to_servers_table', 301);
INSERT INTO "migrations" ("id", "migration", "batch") VALUES (302, '2025_11_16_000001_create_webhook_notification_settings_table', 302);
INSERT INTO "migrations" ("id", "migration", "batch") VALUES (303, '2025_11_16_000002_create_cloud_init_scripts_table', 303);
INSERT INTO "migrations" ("id", "migration", "batch") VALUES (304, '2025_11_17_092707_add_traefik_outdated_to_notification_settings', 304);
INSERT INTO "migrations" ("id", "migration", "batch") VALUES (305, '2025_11_17_145255_add_comment_to_environment_variables_table', 305);
INSERT INTO "migrations" ("id", "migration", "batch") VALUES (306, '2025_11_18_083747_cleanup_dockerfile_data_for_non_dockerfile_buildpacks', 306);
INSERT INTO "migrations" ("id", "migration", "batch") VALUES (307, '2025_11_26_124200_add_build_cache_settings_to_application_settings', 307);
INSERT INTO "migrations" ("id", "migration", "batch") VALUES (308, '2025_11_28_000001_migrate_clickhouse_to_official_image', 308);
INSERT INTO "migrations" ("id", "migration", "batch") VALUES (309, '2025_12_04_134435_add_deployment_queue_limit_to_server_settings', 309);
INSERT INTO "migrations" ("id", "migration", "batch") VALUES (310, '2025_12_05_000000_add_docker_images_to_keep_to_application_settings', 310);
INSERT INTO "migrations" ("id", "migration", "batch") VALUES (311, '2025_12_05_100000_add_disable_application_image_retention_to_server_settings', 311);
INSERT INTO "migrations" ("id", "migration", "batch") VALUES (312, '2025_12_08_135600_add_performance_indexes', 312);
INSERT INTO "migrations" ("id", "migration", "batch") VALUES (313, '2025_12_10_135600_add_uuid_to_cloud_provider_tokens', 313);
INSERT INTO "migrations" ("id", "migration", "batch") VALUES (314, '2025_12_15_143052_trim_s3_storage_credentials', 314);
INSERT INTO "migrations" ("id", "migration", "batch") VALUES (315, '2025_12_17_000001_add_is_wire_navigate_enabled_to_instance_settings_table', 315);
INSERT INTO "migrations" ("id", "migration", "batch") VALUES (316, '2025_12_17_000002_add_restart_tracking_to_standalone_databases', 316);
INSERT INTO "migrations" ("id", "migration", "batch") VALUES (317, '2025_12_24_095507_add_server_to_shared_environment_variables_table', 317);
INSERT INTO "migrations" ("id", "migration", "batch") VALUES (318, '2025_12_24_133707_add_predefined_server_variables_to_existing_servers', 318);
INSERT INTO "migrations" ("id", "migration", "batch") VALUES (319, '2025_12_25_072315_add_cmd_healthcheck_to_applications_table', 319);
INSERT INTO "migrations" ("id", "migration", "batch") VALUES (320, '2026_02_26_163035_add_stripe_refunded_at_to_subscriptions_table', 320);
INSERT INTO "migrations" ("id", "migration", "batch") VALUES (321, '2026_02_27_000000_add_public_port_timeout_to_databases', 321);
INSERT INTO "migrations" ("id", "migration", "batch") VALUES (322, '2026_03_11_000000_add_server_metadata_to_servers_table', 322);
INSERT INTO "migrations" ("id", "migration", "batch") VALUES (323, '2026_03_16_000000_add_is_preview_suffix_enabled_to_volume_tables', 323);
INSERT INTO "migrations" ("id", "migration", "batch") VALUES (324, '2026_03_23_101720_add_uuid_to_local_persistent_volumes_table', 324);
INSERT INTO "migrations" ("id", "migration", "batch") VALUES (325, '2026_03_26_000000_make_ports_exposes_nullable_in_applications_table', 325);
INSERT INTO "migrations" ("id", "migration", "batch") VALUES (326, '2026_03_27_000000_add_max_restart_count_to_applications', 326);
INSERT INTO "migrations" ("id", "migration", "batch") VALUES (327, '2026_03_29_000000_encrypt_existing_clickhouse_admin_passwords', 327);
INSERT INTO "migrations" ("id", "migration", "batch") VALUES (328, '2026_03_30_120000_add_docker_registry_image_tag_to_application_previews_and_deployment_queues', 328);
INSERT INTO "migrations" ("id", "migration", "batch") VALUES (329, '2026_04_19_000000_backfill_and_encrypt_webhook_secrets', 329);
INSERT INTO "migrations" ("id", "migration", "batch") VALUES (330, '2026_04_22_183029_add_is_mcp_server_enabled_to_instance_settings_table', 330);
INSERT INTO "migrations" ("id", "migration", "batch") VALUES (331, '2026_04_28_151408_add_connection_timeout_to_server_settings', 331);
INSERT INTO "migrations" ("id", "migration", "batch") VALUES (332, '2026_05_11_000000_add_configuration_snapshot_to_application_deployment_queues_table', 332);
INSERT INTO "migrations" ("id", "migration", "batch") VALUES (333, '2026_05_13_000000_add_expiration_warning_sent_at_to_personal_access_tokens_table', 333);
INSERT INTO "migrations" ("id", "migration", "batch") VALUES (334, '2026_05_27_000000_add_push_server_update_job_indexes', 334);
INSERT INTO "migrations" ("id", "migration", "batch") VALUES (335, '2026_05_27_000001_tune_postgres_fillfactor_and_autovacuum', 335);
INSERT INTO "migrations" ("id", "migration", "batch") VALUES (336, '2026_05_29_000000_encrypt_application_deployment_configuration_columns', 336);
INSERT INTO "migrations" ("id", "migration", "batch") VALUES (337, '2026_05_31_000000_add_health_check_to_standalone_databases', 337);
INSERT INTO "migrations" ("id", "migration", "batch") VALUES (338, '2026_06_01_000000_drop_subscriptions_table', 338);
INSERT INTO "migrations" ("id", "migration", "batch") VALUES (339, '2026_07_19_010000_add_team_id_to_applications_and_services', 339);
INSERT INTO "migrations" ("id", "migration", "batch") VALUES (340, '2026_07_28_120442_drop_hetzner_columns_from_servers_table', 340);
INSERT INTO "migrations" ("id", "migration", "batch") VALUES (341, '2026_08_03_212408_add_oauth_provider_to_users_table', 341);
