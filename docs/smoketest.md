...
- [ ] Confirm Hetzner Cloud server creation is **not** offered anywhere on this page (deliberate scope decision, Phase 77) — only reachable via `Server\Show`'s still-Livewire chrome.
