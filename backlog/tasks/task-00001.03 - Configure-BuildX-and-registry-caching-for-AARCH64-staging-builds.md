...
Not applicable to this fork, same as task-00001.02 — no `coolify-staging-build.yml` workflow exists here, and no self-hosted ARM64 runner is part of this fork's CI. Left as "To Do" to reflect that it's genuinely undone, but it's out of scope rather than pending.
