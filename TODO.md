...
- 43 of 84 full-page Livewire components converted to Inertia + React.
- Easy and Medium buckets: 100% done (25/25).
- Hard bucket: 16 of 59 done, including the shared `Server` navbar/sidebar chrome that the remaining Server-scoped pages build on.

## Still to do

**Migration**
- 43 Hard-bucket pages remain on Livewire, including 9 of 21 `Server\Navbar`-dependent pages (Sentinel, Proxy, Metrics, Hetzner Token, Terminal command, `Server\Show`, and others).
