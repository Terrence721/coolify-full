<x-layout-simple>
    <section class="bg-gray-50 dark:bg-base" data-two-factor>
                ...
                <div class="space-y-6">
                    ...
                    <div data-two-factor-panel="code"
                        ...
                        <div class="flex gap-3">
                            <svg class="size-5 shrink-0 mt-0.5 text-coollabs dark:text-warning"
                    ...
                    <form action="/two-factor-challenge" method="POST" class="flex flex-col gap-4">
                        @csrf
                        <div data-two-factor-panel="code">
                            <input type="hidden" name="code" data-two-factor-code>
                            <div class="flex gap-2 justify-center" data-two-factor-digits>
                                @for ($i = 0; $i < 6; $i++)
                                    <input type="text" inputmode="numeric" maxlength="1" data-two-factor-digit
                            ...
                            <button type="button" data-two-factor-toggle
                        ...
                        <div data-two-factor-panel="recovery" class="hidden">
