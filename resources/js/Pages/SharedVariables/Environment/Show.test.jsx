...
describe('SharedVariables/Environment/Show', () => {
    ...
    it('passes through props to SharedVariablesManager', () => {
        const testProps = { testProp: 'environment-show', other: 'value' };

        render(<Show {...testProps} />);

        expect(screen.getByText(/Manager: environment-show/)).toBeInTheDocument();
    });
});
