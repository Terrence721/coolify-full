                ...
                <form className="flex flex-col gap-2" onSubmit={submit}>
                    <div className="flex gap-2">
                        ...
                        <label className="flex flex-col gap-1 w-full">
                            Description
                            <input
                                id="add-storage-description"
                                name="add-storage-description"
                    ...
                    <label className="flex flex-col gap-1">
                        Region
                        <input
                            id="add-storage-region"
                            name="add-storage-region"
                            required
                            value={data.region}
                    ...
                    <label className="flex flex-col gap-1">
                        Bucket
                        <input
                            id="add-storage-bucket"
                            name="add-storage-bucket"
                            required
                            value={data.bucket}
