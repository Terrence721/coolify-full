...
import { TERMINAL_SESSION_DANGER_SECONDS, TERMINAL_SESSION_WARNING_SECONDS, formatTerminalSessionRemainingTime } from '../terminal-session-timer';
        ...
        <div id="terminal-container">
                        ...
                        <div className="flex flex-col items-center justify-center space-y-4">
                            ...
                            <div className="text-center">
                                ...
                                <p className="mt-2 text-sm text-neutral-300">
                                    No shell (bash/sh) is available in this container. Please ensure either bash or sh is installed to use the
                                    terminal.
                                </p>
                            </div>
                        </div>
            ...
            >
                            ...
                            {!state.mobileToolbarCollapsed && (
                                <div className="mt-1 grid grid-cols-6 gap-1">
                                    <button
                                        ...
                                        onClick={() => sessionRef.current?.sendTerminalControl('arrowUp')}
                                    ...
                                    <button
                                        type="button"
                                        className="terminal-mobile-key"
                                        onClick={() => sessionRef.current?.sendTerminalControl('arrowDown')}
                                    ...
                                    <button
                                        type="button"
                                        className="terminal-mobile-key"
                                        onClick={() => sessionRef.current?.sendTerminalControl('arrowLeft')}
                                    ...
                                    <button
                                        type="button"
                                        className="terminal-mobile-key"
                                        onClick={() => sessionRef.current?.sendTerminalControl('arrowRight')}
                                    ...
                                    <button
                                        type="button"
                                        className="terminal-mobile-key"
                                        onClick={() => sessionRef.current?.sendTerminalControl('tab')}
                                    >
                                        Tab
                                    </button>
                                    <button
                                        type="button"
                                        className="terminal-mobile-key"
                                        onClick={() => sessionRef.current?.sendTerminalControl('escape')}
                                    >
                                        Esc
                                    </button>
                                </div>
                ...
                {state.fullscreen && (
                    <button
                        title="Minimize"
                        className="fixed bg-black/40 top-4 right-6 text-white"
                        onClick={() => sessionRef.current?.makeFullscreen()}
                    >
